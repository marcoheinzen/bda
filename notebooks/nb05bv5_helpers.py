...
"""
nb05bv5_helpers.py — V5 kernel-based zonal sampling at points (KERNEL_SIZE=5, no SAR filter).

V5 is V4 with one architectural change: KERNEL_SIZE = 5 (5x5 = 25 pixels per
...
def _print_banner():
    print(f"  nb05bv5_helpers loaded — kernel-based sampling (V5: 5x5, no SAR filter)")
