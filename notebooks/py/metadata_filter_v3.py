...
_METADATA_PATTERNS: tuple[re.Pattern, ...] = (
    ...
    # v29 era variants (double-underscore aggregator suffix) AND v3 suffix-less variants
    re.compile(r'^s1__(?:vv|vh|coh)__scenes_observed(?:__\w+)?$'),
    re.compile(r'^s2__scenes_observed(?:__\w+)?$'),
    re.compile(r'^s2__lu__scenes_observed(?:__\w+)?$'),
