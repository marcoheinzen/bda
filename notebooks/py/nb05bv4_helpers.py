...
"""
nb05bv4_helpers.py — V4 kernel-based zonal sampling at points.

V4 is V3 with one architectural change: instead of sampling 1 pixel at each
point's (row, col), V4 extracts a KERNEL_SIZE x KERNEL_SIZE window centered on
the point and computes the v29 statistic-aware reductions over those pixels.
...
KERNEL_SIZE = 3  # default 3x3 = 9 pixels around each point. Override via global.
...
def _print_banner():
    print(f"  nb05bv4_helpers loaded — kernel-based sampling")
